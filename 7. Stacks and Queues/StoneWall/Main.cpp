...
the height of the wall from I to I+1 meters to the right of its left end. In 
particular, H[0] is the height of the wall's left end and H[N−1] is the height of the 
wall's right end.
...
Results (100%):
https://app.codility.com/demo/results/training2Y3MAH-PXP/
...
void test( std::vector< int > H, int expected )
{
	auto got = solution( H );
	if ( got != expected ) {
